          ...
          SingleChildScrollView(            
            ...
            child: Column(
                ...
                children:<Widget>[
                    ...
                    Text(teste.toString()),
                    EmailPasswordForm(callback: _authCallback, ecallback: _authError),
  ...
  _authCallback(result) async{
    try{
      ...
      if (user.uid.length > 0 && user.uid != null){
        var role = await Auth().getCurrentUserRole();
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Você precisa verificar seu email ("+email+") antes de continuar."),
          actions: <Widget>[
            new FlatButton(
              child: new Text("OK"),
              onPressed: () {
