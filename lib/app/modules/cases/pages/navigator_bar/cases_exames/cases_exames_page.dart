...
class CasesExamesPage extends StatefulWidget {
  ...
  const CasesExamesPage({Key key, this.title = "CasesExames", this.model})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            Container(
              child: Image.network(
                widget.model.imageUrlTree, //widget.casesModel.imageUrlTree,
                height: 300,
                width: 300,
              ),
            ),
            ...
            Container(
              height: 50,
              child: Text(
                widget.model.topicTree, //widget.casesModel.textTree,
            ...
            Container(
              height: 300,
              child: Text(
                widget.model.textTree, //widget.casesModel.textTree,
                style: TextStyle(fontSize: 18),
              ),
            ),
          ],
