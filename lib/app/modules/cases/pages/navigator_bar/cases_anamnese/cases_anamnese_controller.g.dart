...
part of 'cases_anamnese_controller.dart';
...
mixin _$CasesAnamneseController on _CasesAnamneseBase, Store {
  final _$editModeAtom = Atom(name: '_CasesAnamneseBase.editMode');
  ...
  final _$casesListAtom = Atom(name: '_CasesAnamneseBase.casesList');
  ...
  final _$_CasesAnamneseBaseActionController =
      ActionController(name: '_CasesAnamneseBase');

  @override
  dynamic getList() {
    final _$actionInfo = _$_CasesAnamneseBaseActionController.startAction();
    try {
      return super.getList();
    } finally {
      _$_CasesAnamneseBaseActionController.endAction(_$actionInfo);
    }
  }
