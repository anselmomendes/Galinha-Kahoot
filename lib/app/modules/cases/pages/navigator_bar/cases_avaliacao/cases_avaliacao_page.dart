...
class CasesAvaliacaoPage extends StatefulWidget {
  final String title;
  const CasesAvaliacaoPage({Key key, this.title = "CasesAvaliacao"})
      : super(key: key);
          ...
          children: <Widget>[
                ...
                return Container(
                  child: Image.network(
                    controller.store.casesModel
                        .imageUrlTwo, //widget.casesModel.imageUrlTwo,
                    height: 300,
                    width: 300,
                  ),
                );
            ...
            Observer(builder: (_) {
              return Container(
                height: 50,
                child: Text(
                  controller.store.casesModel.topicTwo,
            ...
            Observer(builder: (_) {
              return Container(
                ...
                child: Text(
                  controller
                      .store.casesModel.textTwo, //widget.casesModel.textTwo,
                  style: TextStyle(fontSize: 18),
                ),
              );
            }),
