...
class _CasesSintomasPageState extends State<CasesSintomasPage> {
  @override
  void initState() {
//    lessons = getLessons();
    super.initState();
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Column(children: <Widget>[
                  Text(
                    "Paciente de 40 anos, 36 semanas de idade gestacional, foi admitida na maternidade de um hospital, queixando-se de dor abdominal intensa, localizada em hipocôndrio superior direito.\n\nPresença de náuseas, vômito, hiporexia e astenia. Relatava que os sintomas haviam iniciado há 48 horas. Negava febre e perdas vaginais. Havia ainda na ocasião relato de oligúria.",
