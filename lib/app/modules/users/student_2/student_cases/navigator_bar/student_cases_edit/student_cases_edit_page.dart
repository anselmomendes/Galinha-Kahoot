...
import 'package:PeensA/app/modules/users/student_2/student_cases/navigator_bar/student_cases_edit/student_cases_edit_controller.dart';
import 'package:PeensA/app/shared/widgets/raise_button/RaiseButton.dart';
import 'dart:io';
import 'package:image_cropper/image_cropper.dart';
import 'package:image_picker/image_picker.dart';

class StudentCasesEditPage extends StatefulWidget {
  final String title;
  final ComponentModel model;
  const StudentCasesEditPage({Key key, this.title = "Editar Campos", this.model})
      : super(key: key);

  @override
  _StudentCasesEditPageState createState() => _StudentCasesEditPageState();
}

class _StudentCasesEditPageState
    extends ModularState<StudentCasesEditPage, StudentCasesEditController> {
