...
import 'package:PeensA/app/modules/users/student_2/student_cases/navigator_bar/student_cases_quiz_edit/student_cases_quiz_edit_controller.dart';
import 'package:PeensA/app/shared/widgets/raise_button/RaiseButton.dart';


class StudentCasesQuizEditPage extends StatefulWidget {
  final String title;
  final QuizModel model;
  const StudentCasesQuizEditPage({Key key, this.title = "Editar Questões", this.model})
      : super(key: key);

  @override
  _StudentCasesQuizEditPageState createState() => _StudentCasesQuizEditPageState();
}

class _StudentCasesQuizEditPageState
    extends ModularState<StudentCasesQuizEditPage, StudentCasesQuizEditController> {
