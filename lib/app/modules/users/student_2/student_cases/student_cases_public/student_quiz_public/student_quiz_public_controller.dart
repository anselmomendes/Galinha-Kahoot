...
part 'student_quiz_public_controller.g.dart';

class StudentQuizPublicController = _StudentQuizPublicControllerBase
    with _$StudentQuizPublicController;

abstract class _StudentQuizPublicControllerBase with Store {
