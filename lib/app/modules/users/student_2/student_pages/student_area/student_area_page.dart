...
class StudentAreaPage extends StatefulWidget {
  final String title;
  const StudentAreaPage({Key key, this.title = "StudentArea"})
      : super(key: key);

  @override
  _StudentAreaPageState createState() => _StudentAreaPageState();
}

class _StudentAreaPageState extends State<StudentAreaPage> {
  @override
