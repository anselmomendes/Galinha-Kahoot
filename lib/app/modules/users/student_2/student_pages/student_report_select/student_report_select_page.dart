...
import 'student_report_select_controller.dart';

class StudentReportSelectPage extends StatefulWidget {
  final bool showAppBar;
  final String title;

  const StudentReportSelectPage(
      {Key key, this.title = "Relatório", this.showAppBar})
      : super(key: key);

  @override
  _StudentReportSelectPageState createState() =>
      _StudentReportSelectPageState();
}

class _StudentReportSelectPageState extends ModularState<
    StudentReportSelectPage, StudentReportSelectController> {
