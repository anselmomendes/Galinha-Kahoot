...
part of 'teacher_report_select_controller.dart';
...
mixin _$TeacherReportSelectController
    on _TeacherReportSelectControllerBase, Store {
  final _$classListAtom =
      Atom(name: '_TeacherReportSelectControllerBase.classList');
  ...
  final _$_TeacherReportSelectControllerBaseActionController =
      ActionController(name: '_TeacherReportSelectControllerBase');

  @override
  dynamic getList() {
    final _$actionInfo =
        _$_TeacherReportSelectControllerBaseActionController.startAction();
    try {
      return super.getList();
    } finally {
      _$_TeacherReportSelectControllerBaseActionController
